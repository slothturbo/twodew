...
self.addEventListener("fetch", (e) => {
  ...
  // Navigations: try network first (fresh deploys win), fall back to cached shell
  ...
  // Hashed build assets: cache-first (their names change on every deploy, so stale is impossible)
